        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ route('farmer.profile') }}">الملف الشخصي</a></li>
            ...
            <div class="col-lg-3">
                <div class="card border-0 shadow-sm mb-4 overflow-hidden" style="border-radius: 15px;">
                    <div class="card-body p-4 text-center">
                        ...
                        <a href="{{ route('farmer.request.create') }}" class="btn btn-primary-qitaf w-100 py-3">
                ...
                <div class="bg-success p-4 rounded-4 text-white position-relative overflow-hidden" style="background: linear-gradient(135deg, #2d5a27 0%, #4a7c2c 100%);">
                    <img src="{{ asset('logo.png') }}" class="position-absolute opacity-10" style="bottom: -20px; left: -20px; width: 150px; transform: rotate(-15deg); filter: brightness(0) invert(1);">
            ...
            <div class="col-lg-9">
                        ...
                        <div class="card border-0 shadow-sm p-3" style="border-radius: 15px;">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="fw-bold mb-0">{{ number_format($totalSpent, 0) }} <small class="fs-6">ر.س</small></h3>
                                    <span class="text-success small fw-bold">{{ $totalRequests > 0 ? '+' : '' }}{{ $totalRequests }} <span class="text-muted fw-normal">طلباً مسجلاً</span></span>
                                </div>
                        ...
                        <div class="card border-0 shadow-sm p-3" style="border-radius: 15px;">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="fw-bold mb-0">{{ $activeWorkers }} <small class="fs-6">عامل</small></h3>
                                    <span class="text-success small fw-bold">{{ $activeRequests }} <span class="text-muted fw-normal">طلباً نشطاً</span></span>
                                </div>
                                <div class="bg-light p-3 rounded-3 text-success">
                        ...
                        <div class="card border-0 shadow-sm p-3" style="border-radius: 15px;">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="fw-bold mb-0">{{ $activeRequests }} <small class="fs-6">طلبات</small></h3>
                                    <span class="text-success small fw-bold">{{ $completedRequests }} <span class="text-muted fw-normal">طلباً مكتملًا</span></span>
                                </div>
                                <div class="bg-light p-3 rounded-3 text-success">
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                    <div class="card-header bg-white border-0 p-4 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('farmer.requests') }}" class="text-decoration-none text-success fw-bold small">عرض جميع الطلبات ←</a>
                    </div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    @forelse ($recentRequests as $request)
                                        <tr>
                                            <td class="px-4 py-3 border-0 fw-bold">{{ $request->service_type }}</td>
                                            <td class="px-4 py-3 border-0 text-muted">{{ $request->start_date?->format('Y/m/d') ?? '-' }}</td>
                                            <td class="px-4 py-3 border-0 text-center">{{ $request->number_of_workers }}</td>
