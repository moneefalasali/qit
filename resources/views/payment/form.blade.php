...
@section('title', 'نموذج الدفع - قطاف القصيم')
...
<div class="payment-container">
    ...
    <form method="POST" action="{{ route('payment.process') }}" id="payment-form">
        ...
        <input type="hidden" name="labor_request_id" value="{{ $laborRequest->id }}">
        ...
        <a href="{{ route('farmer.requests') }}" class="cancel-link">← إلغاء</a>
    </form>
</div>
