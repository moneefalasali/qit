...
@section('title', 'سجل الدفع - قطاف القصيم')
...
<div class="history-container">
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($payments as $payment)
                        <tr>
                            <td>#{{ $payment->id }}</td>
                            <td>{{ $payment->laborRequest->service_type }}</td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('payment.receipt', $payment->id) }}" class="action-btn action-btn-view">عرض الإيصال</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
    ...
    @else
        <div class="empty-state">
            ...
            <a href="{{ route('farmer.requests') }}" style="display: inline-block; background-color: var(--primary-green); color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;">العودة إلى الطلبات</a>
        </div>
    @endif
</div>
@endsection
