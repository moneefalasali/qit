            ...
            <div class="col-lg-2 d-none d-lg-block">
                <div class="bg-white rounded-4 shadow-sm p-3 h-100">
                    ...
                    <ul class="nav flex-column gap-2">
                        <li><a href="<?php echo e(route('admin.dashboard')); ?>" class="admin-nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"><i class="fas fa-chart-line ms-2"></i> لوحة التحكم</a></li>
                        <li><a href="<?php echo e(route('admin.farmers')); ?>" class="admin-nav-link <?php echo e(request()->routeIs('admin.farmers') ? 'active' : ''); ?>"><i class="fas fa-tractor ms-2"></i> إدارة المزارعين</a></li>
                        <li><a href="<?php echo e(route('admin.workers')); ?>" class="admin-nav-link <?php echo e(request()->routeIs('admin.workers') ? 'active' : ''); ?>"><i class="fas fa-users-cog ms-2"></i> إدارة العمال</a></li>
                        <li><a href="<?php echo e(route('admin.requests')); ?>" class="admin-nav-link <?php echo e(request()->routeIs('admin.requests') ? 'active' : ''); ?>"><i class="fas fa-clipboard-list ms-2"></i> إدارة الطلبات</a></li>
                        <li><a href="<?php echo e(route('admin.services')); ?>" class="admin-nav-link <?php echo e(request()->routeIs('admin.services') ? 'active' : ''); ?>"><i class="fas fa-concierge-bell ms-2"></i> إدارة الخدمات</a></li>
                        <li><a href="<?php echo e(route('admin.reports')); ?>" class="admin-nav-link <?php echo e(request()->routeIs('admin.reports') ? 'active' : ''); ?>"><i class="fas fa-file-alt ms-2"></i> التقارير</a></li>
                        <li><a href="<?php echo e(route('admin.activity-log')); ?>" class="admin-nav-link <?php echo e(request()->routeIs('admin.activity-log') ? 'active' : ''); ?>"><i class="fas fa-history ms-2"></i> سجل النشاط</a></li>
                        <li class="mt-4">
