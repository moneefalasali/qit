...
<div class="card admin-card rounded-4 p-4">
    ...
    <form method="GET" class="row g-2 mb-3">
        <div class="col-md-4">
            <input type="text" name="search" class="form-control" placeholder="ابحث باسم المزارع أو الخدمة" value="<?php echo e(request('search')); ?>">
        </div>
        <div class="col-md-3">
            <select name="status" class="form-select">
                ...
                <option value="waiting_for_payment" <?php echo e(request('status') === 'waiting_for_payment' ? 'selected' : ''); ?>>في انتظار الدفع</option>
        ...
        <div class="col-md-3">
            <a href="<?php echo e(route('admin.requests')); ?>" class="btn btn-outline-secondary w-100">إعادة تعيين</a>
        </div>
    </form>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-3 py-3 border-0">
                            <span class="badge <?php echo e($request->status_badge_class); ?>">
