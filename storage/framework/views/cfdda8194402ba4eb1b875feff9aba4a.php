        ...
        <div class="row align-items-center">
            <div class="col-lg-7 ms-auto text-end">
                <div class="hero-card p-3 p-lg-4 rounded-4 shadow-lg" style="background: rgba(255,255,255,0.88); backdrop-filter: blur(2px); border: 1px solid rgba(245, 243, 240, 0.8);">
                    <h1 class="display-6 fw-bold mb-2" style="color: #5e3d03;"><?php echo e(__('messages.app_name')); ?></h1>
                    <h2 class="fs-5 fw-bold mb-3" style="color: #284915;"><?php echo e(__('messages.welcome')); ?></h2>
                    <p class="mb-3 text-dark"><?php echo e(__('messages.about_text')); ?></p>
                    <div class="d-flex gap-2 justify-content-end flex-wrap">
                        <a href="<?php echo e(route('request-labor')); ?>" class="btn btn-primary-qitaf btn-sm px-3 py-2">
                            <i class="fas fa-users ms-2"></i> <?php echo e(__('messages.request_labor')); ?>

                        </a>
                        <a href="<?php echo e(route('register-worker')); ?>" class="btn btn-sm px-3 py-2" style="background-color: #d4c5b0; color: #2d5a27; border: none; font-weight: 600;">
                            <i class="fas fa-user-plus ms-2"></i> <?php echo e(__('messages.register_worker')); ?>
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h3 class="fw-bold" style="color: #2d5a27;">
                <span style="color: #d4c5b0;">←</span> <?php echo e(__('messages.why_choose_us')); ?> <span style="color: #d4c5b0;">→</span>
            </h3>
        </div>
            ...
            <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-2-4 col-sm-6">
                    <div class="feature-card p-3 h-100 rounded-4">
                        <div class="mb-2 text-success fs-4"><i class="<?php echo e($feature['icon']); ?>"></i></div>
                        <h6 class="fw-bold"><?php echo e($feature['title']); ?></h6>
                        <p class="small text-muted mb-0"><?php echo e($feature['text']); ?></p>
                    </div>
                </div>
...
<section class="py-4" style="background: linear-gradient(180deg, #f9f7f4 0%, #ffffff 100%);">
    <div class="container">
        <div class="text-center mb-4">
            <h3 class="fw-bold" style="color: #2d5a27;"><?php echo e(__('messages.our_services')); ?></h3>
        </div>
        <div class="row g-4">
            <?php
                $serviceImages = [
            ...
            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-2-4 col-md-4 col-sm-6">
                    <div class="service-card h-100 rounded-4 overflow-hidden border-0 shadow-sm">
                        <img src="<?php echo e($serviceImage); ?>" class="card-img-top" style="height: 150px; object-fit: cover;" alt="<?php echo e($service->name); ?>">
                        <div class="card-body p-3 text-center">
                            <div class="mb-2 text-success fs-4"><i class="<?php echo e($service->icon ?: 'fas fa-tools'); ?>"></i></div>
                            <h6 class="fw-bold" style="color: #2d5a27;"><?php echo e($service->name); ?></h6>
                            <p class="small text-muted mb-0"><?php echo e($service->description); ?></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row g-4 text-center">
            <div class="col-md-6">
                <div class="stat-box rounded-4 p-4 h-100">
                    <div class="d-flex align-items-center justify-content-center gap-4">
                        <div>
                            <h2 class="fw-bold display-5 mb-0" style="color: #2d5a27;"><?php echo e($totalWorkers); ?>+</h2>
                            <p class="text-muted mb-0"><?php echo e(__('messages.trusted_by')); ?></p>
                        </div>
            ...
            <div class="col-md-6">
                <div class="stat-box rounded-4 p-4 h-100">
                    <div class="d-flex align-items-center justify-content-center gap-4">
                        <div>
                            <h2 class="fw-bold display-5 mb-0" style="color: #2d5a27;"><?php echo e($totalFarmers); ?>+</h2>
                            <p class="text-muted mb-0"><?php echo e(__('messages.about')); ?></p>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qitaf_alqseem\resources\views/home.blade.php ENDPATH**/ ?>