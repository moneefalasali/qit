<?php $__env->startSection('title', 'إدارة الوثائق - قطاف القصيم'); ?>
...
<div class="documents-container">
    ...
    <div class="upload-section" id="uploadSection">
        ...
        <form method="POST" action="<?php echo e(route('worker.documents.upload')); ?>" enctype="multipart/form-data" id="uploadForm">
            <?php echo csrf_field(); ?>
    ...
    <div class="documents-grid">
        <?php $__empty_1 = true; $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="document-card">
                <div class="document-icon"><?php echo e($document['icon']); ?></div>
                <div class="document-name"><?php echo e($document['name']); ?></div>
                <div class="document-info">
                    <p>تم الرفع: <?php echo e($document['uploaded_at']); ?></p>
                    <p>الحجم: <?php echo e(number_format($document['size_mb'], 1)); ?> MB</p>
                </div>
                <span class="document-status status-<?php echo e($document['status']); ?>">
                    <i class="fas <?php echo e($document['status'] === 'verified' ? 'fa-check-circle' : ($document['status'] === 'pending' ? 'fa-hourglass-half' : 'fa-times-circle')); ?>"></i>
                    <?php echo e($document['status_label']); ?>

                </span>
                <div class="document-actions">
                    <?php if(!empty($document['path'])): ?>
                        <a href="<?php echo e(route('worker.documents.download')); ?>" class="action-btn">تحميل</a>
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('worker.documents.delete')); ?>" style="margin:0;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qitaf_alqseem\resources\views\worker\documents.blade.php ENDPATH**/ ?>