        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center gap-2">
                    <select class="form-select form-select-sm" style="min-width: 140px;" onchange="window.location.href='<?php echo e(route('locale.set', ['locale' => '__LOCALE__'])); ?>'.replace('__LOCALE__', this.value)">
                        ...
                        <option value="hi" <?php echo e(app()->getLocale() === 'hi' ? 'selected' : ''); ?>>हिन्दी</option>
                        <option value="ur" <?php echo e(app()->getLocale() === 'ur' ? 'selected' : ''); ?>>اردو</option>
                        <option value="bn" <?php echo e(app()->getLocale() === 'bn' ? 'selected' : ''); ?>>বাংলা</option>
                        <option value="fa-AF" <?php echo e(app()->getLocale() === 'fa-AF' ? 'selected' : ''); ?>>فارسی</option>
                        <option value="ps" <?php echo e(app()->getLocale() === 'ps' ? 'selected' : ''); ?>>پښتو</option>
                    </select>
