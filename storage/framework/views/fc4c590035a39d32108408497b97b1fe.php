<?php $__env->startSection('title', 'الخدمات - قطاف القصيم'); ?>
...
<section class="services-section">
    ...
    <div class="services-grid">
        <div class="service-card">
            <img src="<?php echo e(asset('images/date_harvesting.jpg')); ?>" alt="جني التمور" class="service-image" loading="lazy">
        ...
        <div class="service-card">
            <img src="<?php echo e(asset('images/palm_pollination.jpg')); ?>" alt="تلقيح النخيل" class="service-image" loading="lazy">
            <div class="service-content">
                <h3>تلقيح النخيل</h3>
        ...
        <div class="service-card">
            <img src="<?php echo e(asset('images/palm_pruning.jpg')); ?>" alt="تقليم النخيل" class="service-image" loading="lazy">
            <div class="service-content">
                <h3>تقليم النخيل</h3>
        ...
        <div class="service-card">
            <img src="<?php echo e(asset('images/palm_irrigation.jpg')); ?>" alt="الري والعناية" class="service-image" loading="lazy">
            <div class="service-content">
                <h3>الري والعناية</h3>
        ...
        <div class="service-card">
            <img src="<?php echo e(asset('images/date_sorting.jpg')); ?>" alt="الفرز والتعبئة" class="service-image" loading="lazy">
            <div class="service-content">
        ...
        <div class="service-card">
            <img src="<?php echo e(asset('images/date_transport.jpg')); ?>" alt="تحميل ونقل" class="service-image" loading="lazy">
            <div class="service-content">
                <h3>تحميل ونقل</h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qitaf_alqseem\resources\views\pages\services.blade.php ENDPATH**/ ?>